...
(function() {
	...
	window.UEDITOR_CONFIG = {
		...
		// 服务器统一请求接口路径
		,
		serverUrl : "ueditor/config.html"

		// 工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的重新定义
		,
		toolbars : [ [ 'fullscreen', 'source', '|', 'paragraph', 'fontfamily',
				'fontsize', '|', 'undo', 'redo', '|', 'bold', 'italic',
				...
				'lineheight', '|', 'directionalityltr', 'directionalityrtl',
		...
		// ,iframeCssUrl : 'text/lib/kindeditor/editInner.css' //
