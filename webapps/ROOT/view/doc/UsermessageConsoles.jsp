			...
			<form id="searchMessageconsoleForm">
				<table class="editTable">
					<tr>
						...
						<td><input name="g.GROUPNAME:like" type="text"></td>
					</tr>
					...
					<tr style="text-align: center;">
						<td colspan="8" style="color: red;">
							当按照岗位查询时，回显岗位信息/当按照小组查询时，回显小组信息，其他时刻均不回显示岗位和小组，以提高查询效率.</td>
					</tr>
				</table>
			</form>
		</div>
				...
				<thead>
					<tr>
						...
						<th field="POSTNAME" data-options="sortable:false" width="80">
							岗位名称</th>
						<th field="GROUPNAME" data-options="sortable:false" width="80">
							小组名称</th>
					</tr>
				</thead>
			</table>
