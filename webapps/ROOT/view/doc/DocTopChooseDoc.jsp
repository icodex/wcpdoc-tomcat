		...
		<form id="dom_chooseSearchChoosedoc">
			<table class="editTable">
				<tr>
					...
					<td><input name="DOCDESCRIBE:like" type="text"></td>
					<td class="title">分类:</td>
					<td><input name="C.NAME:like" type="text"> <!-- <input id="PARENTTITLE_RULE" type="text" readonly="readonly"
							style="background: #F3F3E8">
						<input id="PARENTID_RULE" name="TYPEID:=" type="hidden"> --></td>
				</tr>
				<tr>
					<td class="title">读权限:</td>
					<td><select name="A.READPOP:=">
							<%-- 
							<option value="">
							</option> --%>
