			...
			<table class="editTable">
				<tr>
					...
					<td id="imgTdId" rowspan="5"
						style="text-align: center; width: 200px;border-left: solid 1px #d3d3d3;">
						<c:if test="${imgurl!=null}">
							<img style='max-width: 100%;max-height: 300px;' src='${imgurl}' />
						</c:if>
						<c:if test="${pageset.operateType==1||imgurl==null}">
							<img style='max-width: 100%;' src='text/img/none.png' />
						</c:if>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<select  name="joincheck" id="entity_joincheck"
							style="width: 100px;" val="${entity.joincheck}">
							<option value="1">
								是
							</option>
							<option value="0">
					...
					<td colspan="3"><input type="text" style="width: 100px;"
						class="easyui-validatebox"
