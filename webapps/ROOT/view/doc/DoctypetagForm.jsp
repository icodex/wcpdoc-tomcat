	...
	<div data-options="region:'center'">
		<form id="dom_formDoctypetag">
			...
			<table class="editTable">
				...
				<tr>
					<td class="title">名称:<br />&nbsp;</td>
					<td colspan="3"><input type="text" style="width: 375px;"
						class="easyui-validatebox"
						data-options="required:true,validType:[,'maxLength[512]']"
						id="entity_title" name="title" value="${entity.title}"><br />
						多个标签间用逗号分隔</td>
				</tr>
				<tr>
					...
					<td><input type="text" style="width: 120px;"
						...
						id="entity_typetag" name="sort" value="${entity.sort}"></td>
				</tr>
				<tr>
					<td colspan="4" style="text-align: left;">类别的格式为：[序号] - [类别名称],如:1-颜色,在前台展示时类别不被显示<br/>批量创建时排序号为起始序号</td>
				</tr>
				<tr>
	...
	<div data-options="region:'south',border:false">
		<div class="div_button" style="text-align: center; padding: 4px;">
			<c:if test="${pageset.operateType==1}">
				<a id="dom_add_entityDoctypetag" href="javascript:void(0)"
...
<script type="text/javascript">
	var submitAddActionDoctypetag = 'doctypetag/add.do';
	var submitEditActionDoctypetag = 'doctypetag/edit.do';
	...
	$(function() {
		...
		//提交新增数据
		$('#dom_add_entityDoctypetag').bind('click', function() {
			submitFormDoctypetag.postSubmit(submitAddActionDoctypetag);
		});
		//提交修改数据
