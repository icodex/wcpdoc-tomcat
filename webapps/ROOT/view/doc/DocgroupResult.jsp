...
<html>
	<head>
		...
		<script type="text/javascript"
			src="text/lib/kindeditor/zh-CN.js"></script>
	</head>
	...
	//维护知识
	function editDocgroupDocs() {
		var selectedArray = $(gridDocgroup).datagrid('getSelections');
		if (selectedArray.length == 1) {
			$.farm.openWindow( {
				id : 'chooseDocgroupDocsWin',
				width : 850,
				height : 450,
				modal : true,
				url : 'docgroup/form.do?operateType=4&ids=' + selectedArray[0].ID,
				title : '小组知识管理'
			});
		} else {
			$.messager.alert(MESSAGE_PLAT.PROMPT, MESSAGE_PLAT.CHOOSE_ONE_ONLY,
