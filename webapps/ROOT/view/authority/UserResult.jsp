	...
	<div class="easyui-layout" data-options="region:'center',border:false">
				...
				<table class="editTable">
					...
					<tr>
						...
						<td><select name="TYPE:=" style="width: 120px;">
								...
								<option value="4">只读用户</option>
								<option value="5">知识用户</option>
		...
		<div id="userToolbar">
			...
			<div id="mm6" style="width: 150px;">
				<div onclick="setUserType('read')">设置为只读用户</div>
				<div onclick="setUserType('know')">设置为知识用户</div>
			...
			</a> <a href="javascript:void(0)" id="passwordmng"
		...
		if (selectedArray.length > 0) {
			...
			chooseWindowCallBackHandle = function(selectedArray) {
				$.messager.confirm(MESSAGE_PLAT.PROMPT,
						"确认执行批量添加操作,原有岗位将保留，如果用户无权使用该岗位则不会被添加？", function(
								confirmFlag) {
							if (confirmFlag) {
								var postidsvar;
