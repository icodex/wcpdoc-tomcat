...
<body class="container" style="padding: 16px;">
	<div class="row">
		<div class="col-sm-3 ">
			<nav class="bs-docs-sidebar hidden-print hidden-xs hidden-sm affix">
				<ul class="nav bs-docs-sidenav apimenu">
					...
					<li><hr style="margin: 1px;" /></li>
					<!-- 知识接口[查询]、 分类接口[查询] -->
					<li><a href="helper/readme.do#categoryGetApi">分类----[<b>查询</b>]
					</a></li>
					<li><a href="helper/readme.do#knowGetApi">知识----[<b>查询</b>]
					</a></li>
					<li><a href="helper/readme.do#searchApi">全文检索----[<b>查询</b>]
					</a></li>
					<li><hr style="margin: 1px;" /></li>
		...
		<div class="col-sm-9">
			...
			<!-- 知识查询 -->
			<div id="knowGetApi" class="page-header">
				<jsp:include page="comment/knowGetApi.jsp"></jsp:include>
			</div>
			<!-- 全文检索 -->
			<div id="searchApi" class="page-header">
				<jsp:include page="comment/searchApi.jsp"></jsp:include>
			</div>
			<!-- 免登概述-->
