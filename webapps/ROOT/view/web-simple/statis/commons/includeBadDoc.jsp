...
<div class="panel panel-default" style="background-color: #FCFCFA;min-height: 260px;">
	<div class="panel-body">
		<p>
			<span class="glyphicon glyphicon-exclamation-sign  ">差评知识排名
			</span>
		</p>
		<table class="table" style="font-size: 12px;">
			...
			<c:forEach items="${badDocs.resultList}" varStatus="status" var="node">
				<tr>
					<td>
						${status.index+1}
					</td>
					...
					<td>
						...
						<c:if test="${node.GROUPID!=null}">
							...
							<c:if test="${node.JOINCHECK=='0'}">
								<a href="webgroup/Pubshow.do?groupid=${node.GROUPID}"> <span
