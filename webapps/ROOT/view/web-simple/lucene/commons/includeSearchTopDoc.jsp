			...
			<div class="stream-item" id="loop-30">
				<div class="media">
					<c:if test="${topDoc.imgurl!=null}">
						<a class="pull-right  hidden-xs" target="${config_sys_link_newwindow_target}" 
							href="webdoc/view/Pub${topDoc.docid}.html"
							style="max-height: 100px; max-width: 250px;"><img
							alt="${topDoc.title}" class="doc_max_img" src="${topDoc.imgurl}"><br>
							<span class="side_unit_info"></span> </a>
					</c:if>
					<div class="media-body">
						<a class="doc_node_max_title" target="${config_sys_link_newwindow_target}"  
