								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label for="exampleInputEmail1"> 原始密码 <span
		...
		$(function() {
			$('#registSubmitButtonId').bind('click', function() {
				if (!validate('registSubmitFormId')) {
					...
					if (confirm("是否提交数据?")) {
						var secret1=(AuthKeyProvider.encode('${config_password_provider_type}',$('#passwordId').val()));
						$('#passwordId').val(secret1);
						var secret2=(AuthKeyProvider.encode('${config_password_provider_type}',$('#newPasswordId1').val()));
