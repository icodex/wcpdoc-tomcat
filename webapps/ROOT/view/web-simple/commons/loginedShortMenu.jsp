		...
		<div class="col-sm-12">
			<div class="third-part tracking-ad">
				...
				<div class="list-group text-center">
					<a href="<DOC:defaultIndexPage/>" class="list-group-item active"> 进入首页</a>
				</div> 
				<div class="list-group text-center">
					<a href="webuser/PubHome.do?type=know&userid=${USEROBJ.id}" class="list-group-item">我的文档知识</a>
					<a href="webuser/PubHome.do?type=file&userid=${USEROBJ.id}" class="list-group-item">我的资源知识</a>
					<a href="webuser/PubHome.do?type=enjoy&userid=${USEROBJ.id}" class="list-group-item">关注知识</a>
