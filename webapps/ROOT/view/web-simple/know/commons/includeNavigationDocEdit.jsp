...
<div class="panel panel-default " id="docContentMenuId">
	...
	<div class="panel-body"
		...
		<ul id="ContentMenuId" class="doc_vavigat" style="list-style-type: none;height: 410px;"></ul>
	</div>
	...
	function creatMenus(i, obj) {
		if ($(obj).get(0).tagName == 'H1') {
			$('#ContentMenuId').append(
					'<li class="doc_vavigat_h1">' + $(obj).text() + '</li>');
		}
		if ($(obj).get(0).tagName == 'H2') {
			$('#ContentMenuId').append(
					'<li class="doc_vavigat_h2">' + $(obj).text() + '</li>');
		}
		if ($(obj).get(0).tagName == 'H3') {
			$('#ContentMenuId').append(
					'<li class="doc_vavigat_h3">' + $(obj).text() + '</li>');
		}
	}
