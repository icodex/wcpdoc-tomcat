	...
	<c:if test="${TYPE=='AUDIT' }">
		<div class="panel-heading">
			<ul style="margin-left: -20px;line-height: 24px;">
				<li><a style="color: #D9534F;" id='markAuditEditformSuperLink'><span
						class="glyphicon glyphicon-pencil ">&nbsp;辅助修改信息</span></a></li>
				<li><a style="color: #D9534F;" id='markAuditformSuperLink'><span
						class="glyphicon glyphicon-user ">&nbsp;审核意见</span></a></li>
			</ul>
		</div>
	</c:if>
</div>
<script type="text/javascript">
	...
	$(function() {
		...
		$('#markAuditEditformSuperLink').bind('click', function() {
			//location.hash = "markVersionList";
			$('html,body').animate({
				scrollTop : $("a[name='markAuditEditform']").offset().top
			}, 500);
		});
		initLeftMenu();
	});
