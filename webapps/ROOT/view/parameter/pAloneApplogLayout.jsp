	...
	<div data-options="region:'north',border:false">
		<form id="searchLogForm">
			<table class="editTable">
				<tr>
					<td class="title">日志:</td>
					<td><input name="a.DESCRIBES:like" type="text"></td>
					<td class="title">日志级别:</td>
					<td><select name="a.LEVELS:=">
			...
			<thead>
				<tr>
					...
					<th field="LEVELS" data-options="sortable:true" width="80">
						日志级别</th>
					<th field="IP" data-options="sortable:true" width="80">IP</th>
...
<script type="text/javascript">
	...
	function viewDataLog() {
		...
		if (selectedArray.length == 1) {
			var url = url_formActionLog + '?operateType=' + PAGETYPE.VIEW
