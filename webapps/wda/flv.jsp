				...
				<div class="panel panel-default">
					...
					<div class="panel-body" style="text-align: center;">
						<object type="application/x-shockwave-flash"
							data="commons/player_maxi/player_flv_maxi.swf"
							style="margin: auto; max-width: 620px; max-height: 500px; width: 100%; height: 70%;">
							<param name="movie" value="player_flv_maxi.swf" />
							<param name="allowFullScreen" value="true" />
							<param name="FlashVars"
								value="flv=../../<%=wad.getUrl(request.getParameter("key"), "FLV")%>&amp;width=620&amp;height=500&amp;showtime=1&amp;srt=1&amp;skin=skin.jpg&amp;margin=10&amp;startimage=commons/player_maxi/rorobong.jpg&amp;playercolor=cccccc&amp;buttoncolor=333333&amp;buttonovercolor=999999&amp;slidercolor1=333333&amp;slidercolor2=0&amp;sliderovercolor=999999&amp;loadingcolor=0&amp;showfullscreen=1" />
							<p>视频预览</p>
						</object>
					</div>
				</div>
